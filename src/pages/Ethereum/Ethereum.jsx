      ...
      <div className="px-20 mt-10 flex justify-between border-b">
        ...
        <div className={styled.WrapperBitcoinAbout}>
          <div className={styled.BitcoinAbout}>
            ...
            <ul>
              <li>
                Low:<span>$1,883.07</span>
              </li>

              <li>
                <div>
                  High:<span>$1,927.57</span>
                </div>
                <div>
                  <span>24h</span>
                  <svg
      ...
      <div className="flex justify-between px-20 mt-16">
        ...
        <div className="w-[32%]">
          <AsideBitcoin
            ...
            symbol="ETH Price Statistics"
            today="Ethereum Price Today"
            price="Ethereum Price"
            market="Ethereum Market Cap"
            numb="#3"
            money="$1,885.90"
          />
        </div>
