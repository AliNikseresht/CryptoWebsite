...
import bitLogo from "../../assets/tether.png";
  ...
  return (
    <div>
        ...
        <div className={styled.WrapperheadBit}>
          ...
          <ul className={styled.headmore}>
            <li>
              ...
              <span className="mx-1">tether.to</span>
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="13px"
                height="13px"
        ...
        <div className={styled.WrapperBitcoinAbout}>
          <div className={styled.BitcoinAbout}>
            ...
            <ul>
              <li>
                <h2>
                  <span className="pe-1 text-4xl font-semibold">$0.9999</span>
                  <span>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="11px"
          ...
          <div className={styled.BitcoinMarketWrapper}>
            <ul className={styled.marketCap}>
              ...
              <li className="my-1">$83,767,038,408</li>
            ...
            <ul className={styled.marketCap}>
              ...
              <li className="my-1">$86,706,939,487</li>
              <li>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="11px"
      ...
      <div className="flex justify-between px-20 mt-16">
        ...
        <div className="w-[32%]">
          <AsideBitcoin
            title="Tether Community"
            symbol="USDT Price Statistics"
            today="Tether Price Today"
            price="Tether Price"
            market="Tether Market Cap"
            numb="#2"
            money="$0.9999"
          />
        </div>
